                                    ...
                                    <tr data-item="{{  $item }}">
                                        ...
                                        <td>
                                            @include('admin.components.form.switcher',[
                                                ...
                                                'onload'        => true,
                                                'data_target'   => $item->id,
                                                'permission'    => "admin.blog.status.update",
                                            ])
                                        </td>
        
                                        <td>
                                            <a href="{{ setRoute('admin.blog.edit', $item->id) }}" class="btn btn--base"><i
...
@push('script')
    ...
    <script>
        ...
        $(".delete-modal-button").click(function(){
            ...
            var actionRoute =  "{{ setRoute('admin.blog.delete') }}";
        ...
        $(document).ready(function(){
            // Switcher
            switcherAjax("{{ setRoute('admin.blog.status.update') }}");
        })
    </script>
@endpush
